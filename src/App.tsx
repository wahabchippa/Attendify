...
export default function App() {
 ...
 className="w-9 h-9 flex items-center justify-center rounded hover:bg-slate-100 text-slate-600 transition-all active:scale-[0.97]"
 ...
 `}>
 <div className="absolute top-0 right-0 w-32 h-32 bg-slate-900/20 rounded-full pointer-events-none" />
...
<p className="text-center text-slate-700 text-[11px] font-medium mt-3 tracking-wide">
 ...
 ${isActive
 ? 'bg-gradient-to-br from-[#0f172a]/10 to-[#1e293b]/10 text-slate-900'
