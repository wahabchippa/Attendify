...
export default function Settings({ currentUser, onLogout }: SettingsProps) {
 ...
 const inputCls = "w-full bg-slate-50/80 border border-slate-200 rounded px-3.5 py-2.5 text-sm font-semibold text-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-900/20 focus:border-slate-900 transition-all placeholder-slate-400";
 const selectCls = "w-full appearance-none bg-slate-50/80 border border-slate-200 rounded px-3.5 py-2.5 text-sm font-semibold text-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-900/20 focus:border-slate-900 transition-all cursor-pointer";
 ...
 className="flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/20 rounded text-white/80 text-xs font-bold border border-white/10 transition-all active:scale-[0.97]"
 >
 ...
 {secretSaved && (
 <div className="bg-emerald-50 border border-emerald-200 rounded-md p-4 text-emerald-700 text-sm font-bold flex items-center gap-2">
 ...
 {secretError && (
 <div className="bg-red-50 border border-red-200 rounded-md p-4 text-red-700 text-sm font-bold flex items-center gap-2">
 <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
 ...
 <SectionHeader
 icon={<svg className="w-4 h-4 text-slate-900" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4" /></svg>}
 ...
 <InputField label=" ">
 <button onClick={handleSecretAddRecord} className="w-full py-2.5 bg-gradient-to-r from-slate-900 to-slate-800 text-white rounded text-sm font-bold shadow-lg shadow-slate-900/10 transition-all active:scale-[0.97]">
 Add Record
 </button>
 </InputField>
 </div>
 ...
 className="px-3 py-1.5 bg-slate-50 text-slate-900 rounded text-xs font-medium hover:bg-slate-100 border border-slate-200 transition-all active:scale-[0.97]">
 Edit
 </button>
 <button onClick={() => handleSecretDelete(rec.id)}
 className="px-3 py-1.5 bg-red-50 text-red-600 rounded text-xs font-medium hover:bg-red-100 border border-red-200 transition-all active:scale-[0.97]">
 Del
 </button>
 </div>
 </div>
 ...
 <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/40 " onClick={() => setSecretEditRecord(null)}>
 ...
 <button onClick={() => setSecretEditRecord(null)} className="flex-1 py-2.5 rounded border border-slate-200 text-slate-600 text-xs font-bold hover:bg-slate-50 transition-all">Cancel</button>
 <button onClick={handleSecretSave} className="flex-1 py-2.5 rounded bg-gradient-to-r from-slate-900 to-slate-800 text-white text-xs font-bold shadow-lg shadow-slate-900/10 transition-all">Save</button>
 </div>
 </div>
 </div>
 </div>
 ...
 <div className="w-12 h-12 bg-white/15 rounded-md flex items-center justify-center border border-white/20 text-sm font-bold">
 ...
 <button
 onClick={onLogout}
 className="flex items-center gap-2 px-4 py-2.5 bg-white/10 hover:bg-red-500/30 rounded-md text-white/80 hover:text-white text-xs font-bold border border-white/10 transition-all active:scale-[0.97]"
 >
 <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
 ...
 className={`flex items-center gap-2 px-4 py-2.5 rounded-md text-xs font-bold whitespace-nowrap transition-all flex-1 justify-center ${
 activeTab === t.key
 ...
 <svg className="w-5 h-5 text-slate-900 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
 <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z" />
 </svg>
 <p className="text-slate-900 text-sm font-medium">Set individual office timing for each employee.</p>
 </div>
 ...
 subtitle={emp.role}
 badge={
 <button onClick={() => applyToAll(emp.id)} className="px-3 py-1.5 bg-slate-50 hover:bg-slate-100 text-slate-900 rounded text-xs font-medium border border-slate-200 transition-all active:scale-[0.97]">
 Apply to All
 </button>
 }
 />
 ...
 className={`px-6 py-3 rounded-md font-bold text-sm transition-all active:scale-[0.97] shadow-lg ${
 saved
 ? 'bg-emerald-600 text-white shadow-emerald-500/20'
 : 'bg-gradient-to-r from-slate-900 to-slate-800 text-white shadow-slate-900/10'
 }`}
 >
 ...
 className="w-24 bg-white border border-slate-200 rounded px-3 py-2 text-sm text-center font-mono font-black focus:outline-none focus:ring-2 focus:ring-slate-900/20 focus:border-slate-900 transition-all"
 />
 </div>
 </div>
 );
 ...
 <button onClick={handleAddEmployee} className="py-2.5 bg-gradient-to-r from-slate-900 to-slate-800 text-white rounded font-bold text-sm shadow-lg shadow-slate-900/10 transition-all active:scale-[0.97]">
 Add Employee
 </button>
 </div>
 {addMsg && (
 ...
 className="px-2.5 py-1 bg-amber-50 text-amber-600 rounded text-xs font-medium hover:bg-amber-100 border border-amber-200 transition-all active:scale-[0.97]">
 🔄 Reset Device
 </button>
 )}
 {canRemoveEmp && (
 ...
 className="px-2.5 py-1 bg-red-50 text-red-500 rounded text-xs font-medium hover:bg-red-100 border border-red-200 transition-all active:scale-[0.97]">
 Remove
 </button>
 )
 )}
 ...
 <div key={office.id} className="bg-slate-50 rounded-md p-4 border border-slate-100">
 {/* Office Header */}
 ...
 className="flex-1 py-2.5 border-2 border-dashed border-slate-200 rounded-md text-xs font-bold text-slate-700 hover:bg-slate-50 hover:border-slate-400 transition-all">
 + Add New Office
 </button>
 ...
 <button onClick={handleAddHoliday} className="py-2.5 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded font-bold text-sm shadow-md transition-all active:scale-[0.97]">
 Mark Holiday
 </button>
 </div>
 {hMsg && (
 ...
 <div key={h.date} className="flex items-center justify-between bg-slate-50 rounded-md p-4 border border-slate-100 hover:border-purple-200 transition-all">
 <div className="flex items-center gap-3">
 <div className="w-10 h-10 bg-slate-800 rounded flex items-center justify-center shadow-md shadow-purple-500/20">
 ...
 className="px-3 py-1.5 bg-red-50 text-red-500 rounded text-xs font-medium hover:bg-red-100 border border-red-200 transition-all active:scale-[0.97]">
 Remove
 </button>
 </div>
 ))}
