        ...
        <div className="bg-gradient-to-r from-slate-800 via-slate-700 to-slate-900 rounded-lg p-5 text-white relative overflow-hidden shadow-md">
          ...
          <div className="relative z-10 flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/20 rounded text-white/80 text-xs font-bold border border-white/10 transition-all active:scale-95"
            >
        ...
        <div className="bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden">
          ...
          <div className="p-5 space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              ...
              <InputField label=" ">
                <button onClick={handleSecretAddRecord} className="w-full py-2.5 bg-gradient-to-r from-slate-900 to-slate-800 text-white rounded text-sm font-bold shadow-lg shadow-slate-900/10 transition-all active:scale-95">
                  Add Record
                </button>
              </InputField>
            </div>
    ...
    <div className={`space-y-5 font-sans transition-all duration-700 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
      ...
      <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 rounded-lg p-5 md:p-6 text-white relative overflow-hidden shadow-sm">
        ...
        <div className="relative z-10 flex items-center justify-between">
          ...
          <button
            onClick={onLogout}
            className="flex items-center gap-2 px-4 py-2.5 bg-white/10 hover:bg-red-500/30  rounded-md text-white/80 hover:text-white text-xs font-bold border border-white/10 transition-all active:scale-95"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      {activeTab === 'timings' && canEdit && (
        <div className="space-y-4">
          ...
          <button
            ...
            className={`px-6 py-3 rounded-md font-bold text-sm transition-all active:scale-95 shadow-lg ${
              saved
            ...
            <div className="bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden">
              ...
              <div className="p-5 space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                  ...
                  <button onClick={handleAddEmployee} className="py-2.5 bg-gradient-to-r from-slate-900 to-slate-800 text-white rounded font-bold text-sm shadow-lg shadow-slate-900/10 transition-all active:scale-95">
                    Add Employee
                  </button>
                </div>
                {addMsg && (
          ...
          <div className="p-5 space-y-4">
            <div className="bg-slate-50 rounded-md p-4 border border-slate-100">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                ...
                <button onClick={handleAddHoliday} className="py-2.5 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded font-bold text-sm shadow-md transition-all active:scale-95">
                  Mark Holiday
                </button>
              </div>
              {hMsg && (
