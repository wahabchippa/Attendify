...
export default function LoginScreen({ onLogin }: LoginScreenProps) {
 ...
 <div className="w-full max-w-5xl bg-white rounded-lg shadow-lg overflow-hidden grid grid-cols-1 md:grid-cols-5 transition-all duration-200">
 ...
 <div className="relative flex items-center h-12 border border-slate-200 rounded px-4 bg-slate-50/50 focus-within:border-[#0f172a] focus-within:ring-2 focus-within:ring-blue-500/20 transition-all">
 <UserIcon />
 <input
 value={newName}
 ...
 <button
 type="submit"
 className="w-full h-12 bg-gradient-to-r from-slate-900 to-slate-800 hover:from-[#1d4ed8] hover:to-[#3b82f6] text-white rounded font-bold text-sm tracking-wide shadow-lg hover:shadow-blue-500/25 transition-all transform active:scale-[0.97]"
 >
 Submit Request
 </button>
 ...
 className="w-full h-12 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 rounded font-bold text-sm transition-all flex items-center justify-center gap-2 active:scale-[0.97]"
 >
 <BackArrow />
 Back to Login
 </button>
 ...
 <div className={`w-full max-w-sm mx-auto transition-all duration-200 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
 ...
 dropdownOpen
 ? 'border-[#0f172a] ring-2 ring-blue-500/20'
 : selectedEmployee
 ? 'border-[#0f172a]/30 bg-slate-50/30'
 : 'border-slate-200'
 }`}
 >
 ...
 className={`w-full h-12 rounded font-bold text-sm tracking-wide shadow-lg transition-all transform active:scale-[0.97] ${
 selectedEmployee
 ...
 className="w-full h-12 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 rounded font-bold text-sm transition-all flex items-center justify-center gap-2 active:scale-[0.97] hover:border-slate-300"
 >
 <svg className="w-4 h-4 text-slate-900" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
 ...
 <p className="text-[11px] font-semibold mt-0.5">Authenticated User</p>
 </div>
 </div>
 <button
 type="button"
 ...
 : "bg-white border border-slate-200 text-slate-800 text-lg shadow-sm hover:border-[#0f172a] hover:shadow-md hover:shadow-blue-500/10 hover:bg-slate-50/30 active:bg-slate-100/50"
 }`}
 >
 {key === "back" ? (
