...
export default function LocationPermissionDialog({
 ...
 return (
 <div className="fixed inset-0 z-[9998] flex items-center justify-center p-4 bg-black/50 font-sans">
 ...
 <div className="w-8 h-8 bg-amber-100 rounded flex items-center justify-center shrink-0 mt-0.5">
 ...
 className="w-full py-3.5 bg-gradient-to-r from-slate-900 to-slate-800 hover:from-[#1d4ed8] hover:to-[#3b82f6] active:scale-[0.97] text-white font-black rounded-md text-sm transition-all shadow-lg shadow-blue-500/25 flex items-center justify-center gap-2"
 >
 ...
 <button
 onClick={onRetry}
 className="w-full py-3 bg-slate-100 hover:bg-slate-200 active:scale-[0.97] text-slate-700 font-bold rounded-md text-sm transition-all flex items-center justify-center gap-2"
 >
 <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
