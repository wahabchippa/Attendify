        ...
        <div className="px-7 py-6 space-y-5">
          ...
          <div className="space-y-2.5 pt-1">
            <button
              ...
              className="w-full py-3.5 bg-gradient-to-r from-slate-900 to-slate-800 hover:from-[#1d4ed8] hover:to-[#3b82f6] active:scale-[0.98] text-white font-black rounded-md text-sm transition-all shadow-lg shadow-blue-500/25 flex items-center justify-center gap-2"
            >
            ...
            <button
              onClick={onRetry}
              className="w-full py-3 bg-slate-100 hover:bg-slate-200 active:scale-[0.98] text-slate-700 font-bold rounded-md text-sm transition-all flex items-center justify-center gap-2"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
