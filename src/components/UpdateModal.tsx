...
export default function UpdateModal() {
 ...
 <div
 className="h-full bg-gradient-to-r from-[#0f172a] to-[#3B82F6] rounded-full transition-all duration-300 ease-out relative overflow-hidden"
 ...
 className="w-full py-4 bg-gradient-to-r from-slate-900 to-slate-800 hover:from-[#1d4ed8] hover:to-[#3b82f6] active:scale-[0.97] text-white font-black rounded-md text-sm transition-all duration-200 shadow-md shadow-blue-600/25 hover:shadow-blue-500/35 flex items-center justify-center gap-2.5"
 >
