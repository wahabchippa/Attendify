...
const allEmployees = getEmployees();
 ...
 className="flex items-center gap-2 px-4 py-2.5 bg-white/10 hover:bg-white/20 rounded-md text-white text-xs font-bold border border-white/10 transition-all active:scale-[0.97]"
 >
 ...
 className="px-5 py-2.5 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-md text-xs font-bold shadow-lg transition-all active:scale-[0.97]"
 >
 + Add Salary Config
 </button>
 </div>
 ...
 className={`w-full py-4 rounded-md font-black text-sm transition-all active:scale-[0.97] shadow-lg ${
 configSaved
