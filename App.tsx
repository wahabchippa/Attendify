...
import { generateDemoData } from './store';
      ...
      <header className="lg:hidden fixed top-0 left-0 right-0 z-40 bg-white border-b border-slate-200 px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-slate-800 font-semibold text-sm">Attendance</span>
          </div>
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-5 border-b border-slate-700">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-white font-semibold">Attendance</h1>
                <p className="text-slate-400 text-xs">WiFi Based System</p>
              </div>
            </div>
          </div>
